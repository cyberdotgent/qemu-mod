...
/*
 * Load String and Compare Byte Indexed: load up to XER[BC] bytes,
 * stopping after the first byte equal to XER[CMP]. Returns the number
 * of bytes loaded, including the matching byte, for XER[BC].
 */
