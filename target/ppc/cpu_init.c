...
static void register_601_sprs(CPUPPCState *env)
{
    ...
    spr_register(env, SPR_MQ, "MQ",
                 ...
                 &spr_read_generic, &spr_write_generic,
                 0x00000000);
    /* RTC registers: SPR 20/21 are supervisor write-only, 4/5 read-only */
    ...
    spr_register(env, SPR_EAR, "EAR",
                 ...
                 &spr_read_generic, &spr_write_generic,
                 0x00000000);
    /* Memory management: 4 unified BATs with the 601 register format */
...
POWERPC_FAMILY(601)(ObjectClass *oc, const void *data)
{
    DeviceClass *dc = DEVICE_CLASS(oc);
    PowerPCCPUClass *pcc = POWERPC_CPU_CLASS(oc);
...
POWERPC_FAMILY(601v)(ObjectClass *oc, const void *data)
{
    DeviceClass *dc = DEVICE_CLASS(oc);
    PowerPCCPUClass *pcc = POWERPC_CPU_CLASS(oc);
