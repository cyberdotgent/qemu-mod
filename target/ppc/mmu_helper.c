...
/*
 * PowerPC 601 unified BATs: the same four BAT pairs are used for
 * instruction and data accesses, so both arrays are kept in sync.
 * The valid bit (0x40) and the block length live in the lower word.
 */
